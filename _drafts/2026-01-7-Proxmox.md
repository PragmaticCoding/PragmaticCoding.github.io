...
Another very convenient way to create a guest machine, either LXC or VM is via the [Proxmox VE Helper-Scripts]({{page.CommunityScripts}}).  At the time of this writing, there are 433 scripts that you can choose from, divided into 26 catagories.  
